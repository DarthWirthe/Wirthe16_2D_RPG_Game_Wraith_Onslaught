...
local dialogs = {
[1]={["text"] = "Наша деревня называется Зелёный Камень, потому что находится над залежами из зелёной горной породы.",
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[2]={["text"] = "Не всякое зелье полезно.",
	{["text"] = lang("Услуги торговли"),["action"] = "trade", ["do"] = 3},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[3]={["text"] = "Сейчас важно иметь при себе какое-нибудь оружие.",
	{["text"] = lang("Услуги торговли"),["action"] = "trade", ["do"] = 1},
	{["text"] = lang("Услуги кузнеца"),["action"] = "craft", ["do"] = 1},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[4]={["text"] = "Чудовища даже не попытались атаковать нашу деревню.",
	...
	{["text"] = lang("Да, я хочу выйти"),["action"] = "setWorld", ["do"] = {2,1}, ["reqlvl"] = 1},
	{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[5]={["text"] = "Доброго пути.",
	{["text"] = lang("Вернуться"), ["action"] = "dialog", ["do"] = {
		...
		{["text"] = lang("Мне нужно поскорее вернуться"),["action"] = "setWorld", ["do"] = {1,1}, ["reqlvl"] = 1},
		{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[6]={["text"] = ".",
	{["text"] = lang("Вернуться"), ["action"] = "dialog", ["do"] = {
		...
		{["text"] = lang("Да"),["action"] = "setWorld", ["do"] = {4,1}, ["reqlvl"] = 1},
...
[9]={["text"] = "Доспехи многое значат в серьёзных сражениях.",
	{["text"] = lang("Услуги торговли"),["action"] = "trade", ["do"] = 2},
	{["text"] = lang("Услуги портного"),["action"] = "craft", ["do"] = 2},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[10]={["text"] = "",
	{["text"] = lang("Использование телепорта"), ["action"] = "dialog", ["do"] = {
		["text"] = "Вы уверены что хотите переместиться в восточное поселение?",
		{["text"] = lang("Да"),["action"] = "setWorld", ["do"] = {4,-82}, ["reqlvl"] = 1},
		{["text"] = lang("Нет"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("Не сейчас"),["action"] = "close", ["do"] = nil},
	},
[11]={["text"] = "",
	{["text"] = lang("Использование телепорта"), ["action"] = "dialog", ["do"] = {
		["text"] = "Вы уверены что хотите переместиться в деревню Зеленый Камень?",
		{["text"] = lang("Да"),["action"] = "setWorld", ["do"] = {1,-97}, ["reqlvl"] = 1},
		{["text"] = lang("Нет"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("Не сейчас"),["action"] = "close", ["do"] = nil},
	},
[12]={["text"] = "Я живу здесь уже много лет.",
	nil,
	{["text"] = lang("Услуги проводника"), ["action"] = "dialog", ["do"] = {
		["text"] = "Чем могу помочь?",
		{["text"] = lang("Мне нужно попасть в старый могильник"), ["action"] = "dialog", ["do"] = {
			...
			{["text"] = lang("Я справлюсь"), ["action"] = "dialog", ["do"] = {
				...
				{["text"] = lang("Да"), ["action"] = "setWorld", ["do"] = {3,1}, ["reqlvl"] = 5},
				{["text"] = lang("Нет"),["action"] = "close", ["do"] = nil},
			}},
			{["text"] = lang("Мне кажется, я не справлюсь"),["action"] = "close", ["do"] = nil},
		}},
		{["text"] = lang("Мне нужно попасть в тайное подземелье"), ["action"] = "dialog", ["do"] = {
			["text"] = "Вы уверены что хотите отправиться в подземелье? Требуется уровень 7 и выше.",
			{["text"] = lang("Да"), ["action"] = "setWorld", ["do"] = {7,1}, ["reqlvl"] = 7},
			{["text"] = lang("Нет"),["action"] = "close", ["do"] = nil},
		}},
		{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	}},
...
[13]={["text"] = "",
	["text"] = "Войти в могильник?",
	{["text"] = lang("Да"),["action"] = "setWorld", ["do"] = {5,1}, ["reqlvl"] = 1},
	{["text"] = lang("Нет"),["action"] = "close", ["do"] = nil},
	},
[14]={["text"] = "",
	nil,
...
[15]={["text"] = "Использовать камень телепорта",
	{["text"] = lang("Переместиться"), ["action"] = "dialog", ["do"] = {
		["text"] = "Перемещение",
		{["text"] = lang("Деревня Зеленый Камень"),["action"] = "setWorld", ["do"] = {1,1}, ["reqlvl"] = 1},
		{["text"] = lang("Восточное поселение"),["action"] = "setWorld", ["do"] = {4,1}, ["reqlvl"] = 3},
		{["text"] = lang("Не сейчас"),["action"] = "close", ["do"] = nil},
	}},	
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[16]={["text"] = "Мы готовы отразить любую атаку противника.",
	{["text"] = lang("Покинуть это место"), ["action"] = "dialog", ["do"] = {
	["text"] = "Вы хотите выйти?",
	{["text"] = lang("Да, я хочу выйти"),["action"] = "setWorld", ["do"] = {6,1}, ["reqlvl"] = 1},
	{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[17]={["text"] = "Мы готовы отразить любую атаку противника.",
	...
	{["text"] = lang("Вернуться"), ["action"] = "dialog", ["do"] = {
		["text"] = "Вы хотите войти?",
		{["text"] = lang("Мне нужно поскорее вернуться"),["action"] = "setWorld", ["do"] = {4,-5}, ["reqlvl"] = 1},
		{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[18]={["text"] = "Алхимия - одно из древних ремёсел.",
	{["text"] = lang("Услуги алхимика"),["action"] = "craft", ["do"] = 3},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[19]={["text"] = "",
	{["text"] = lang("Выйти"),["action"] = "setWorld", ["do"] = {4,1}, ["reqlvl"] = 1},
	{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	},
[20]={["text"] = "Чудовища предусмотрены самой природой.",
	nil,
	{["text"] = lang("Услуги проводника"), ["action"] = "dialog", ["do"] = {
		["text"] = "",
		{["text"] = lang("•Пройти к горной долине"), ["action"] = "dialog", ["do"] = {
			["text"] = "Я один из немногих, кто знает тайный путь в долину. Вы готовы отправиться в долину мрачных миражей? [Требуемый уровень 11]",
			{["text"] = lang("Я готов"),["action"] = "setWorld", ["do"] = {10,1}, ["reqlvl"] = 11},
			{["text"] = lang("Не сейчас"),["action"] = "close", ["do"] = nil}
		}},	
		{["text"] = lang("•Пройти к храму Увеула"), ["action"] = "dialog", ["do"] = {
			["text"] = "Вы готовы отправиться в храм? [Требуемый уровень 12]",
			{["text"] = lang("Я готов"),["action"] = "setWorld", ["do"] = {12,1}, ["reqlvl"] = 12},
			{["text"] = lang("Не сейчас"),["action"] = "close", ["do"] = nil}
		}},
		{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	}},
...
[22]={["text"] = "",
	{["text"] = lang("Покинуть это место"), ["action"] = "dialog", ["do"] = {
	["text"] = "Вы хотите выйти?",
	{["text"] = lang("Да, я хочу выйти"),["action"] = "setWorld", ["do"] = {9,1}, ["reqlvl"] = 1},
	{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[23]={["text"] = "",
	...
	{["text"] = lang("Вернуться"), ["action"] = "dialog", ["do"] = {
		["text"] = "Вы хотите войти?",
		{["text"] = lang("Мне нужно поскорее вернуться"),["action"] = "setWorld", ["do"] = {8,-5}, ["reqlvl"] = 1},
		{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
...
[25]={["text"] = "",
	{["text"] = lang("Вернуться"), ["action"] = "dialog", ["do"] = {
		...
		{["text"] = lang("Да"),["action"] = "setWorld", ["do"] = {8,1}, ["reqlvl"] = 1},
		{["text"] = lang("Нет"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("Не сейчас"),["action"] = "close", ["do"] = nil},
	},
[26]={["text"] = "У меня есть все инструменты для создания зачарованного оружия!",
	{["text"] = lang("Создание снаряжения"),["action"] = "craft", ["do"] = 4},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[27]={["text"] = "Берегите себя.",
	{["text"] = lang("Создание снаряжения"),["action"] = "craft", ["do"] = 5},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
...
[30]={["text"] = "В окрестностях уже давно водится нечисть.",
	{["text"] = lang("Покинуть это место"), ["action"] = "dialog", ["do"] = {
	["text"] = "Вы хотите выйти?",
	{["text"] = lang("Да, я хочу выйти"),["action"] = "setWorld", ["do"] = {2,1680}, ["reqlvl"] = 1},
	{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[31]={["text"] = "",
	{["text"] = lang("Покинуть это место"), ["action"] = "dialog", ["do"] = {
	["text"] = "Вы хотите выйти?",
	{["text"] = lang("Да, я хочу выйти"),["action"] = "setWorld", ["do"] = {6,1185}, ["reqlvl"] = 1},
	{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
[32]={["text"] = "",
	{["text"] = lang("Войти"), ["action"] = "dialog", ["do"] = {
		["text"] = "Вы хотите войти?",
		{["text"] = lang("Мне нужно поскорее войти"),["action"] = "setWorld", ["do"] = {8,-5}, ["reqlvl"] = 1},
		{["text"] = lang("Позже"),["action"] = "close", ["do"] = nil},
	}},
	{["text"] = lang("До встречи"),["action"] = "close", ["do"] = nil},
	},
...
local gud = {
	...
	{["id"] = 61, ["name"] = "Скелет убитого разбойника", ["wtype"] = 6, ["lvl"] = 10, ["atds"] = 10, ["agr"] = true,
	...
	{["id"] = 92, ["name"] = "Древний доспех", ["wtype"] = 10, ["lvl"] = 20, ["atds"] = 12, ["mhp"] = 18620, ["agr"] = true,
	...
	{["id"] = 94, ["name"] = "Таус'еденвал", ["wtype"] = 10, ["lvl"] = 20, ["atds"] = 12, ["mhp"] = 18620, ["agr"] = true,
	...
	["cmve"] = true,["loot"] = {["exp"] = 0, ["coins"] = 0, ["items"] = "0"}, ["vresp"] = 8^10, ["rtype"] = "e", ["image"] = "evfmv"},
	{["id"] = 105, ["name"] = "Инструмент Увеула", ["wtype"] = 13, ["lvl"] = 20, ["atds"] = 10, ["mhp"] = 20371, ["agr"] = true,
	...
	{["id"] = 108, ["name"] = "Магический страж", ["wtype"] = 12, ["lvl"] = 18, ["atds"] = 10, ["hpmul"] = 7.4, ["agr"] = true,
	["loot"] = {["coins"] = 14, ["items"] = "SIL15_19"},
	["vresp"] = 900, ["rtype"] = "e", ["image"] = "tlwrarikle"},
	{["id"] = 109, ["name"] = "Магический страж", ["wtype"] = 12, ["lvl"] = 19, ["atds"] = 10, ["hpmul"] = 8.7, ["agr"] = true,
	["loot"] = {["coins"] = 14, ["items"] = "SIL15_19"},
	["vresp"] = 900, ["rtype"] = "e", ["image"] = "tlwhwrihgan"},
	{["id"] = 110, ["name"] = "Вход", ["wtype"] = "", ["lvl"] = 0, ["tlp"] = {13,1},
	["image"] = "hallway_gate", ["rtype"] = "c"},
	{["id"] = 111, ["name"] = "Выход", ["wtype"] = "", ["lvl"] = 0, ["tlp"] = {12,2060},
	["image"] = "hallway_gate", ["rtype"] = "c"},
	{["id"] = 112, ["name"] = "Нечеловеческий", ["wtype"] = 13, ["lvl"] = 22, ["atds"] = 10, ["mhp"] = 27869, ["agr"] = true,
	...
	{["id"] = 113, ["name"] = "Гнилой дух", ["wtype"] = 12, ["lvl"] = 20, ["atds"] = 10, ["hpmul"] = 3.8, ["agr"] = true,
	...
	{["id"] = 115, ["name"] = "Злой • Сипри Соруим", ["wtype"] = 13, ["lvl"] = 30, ["atds"] = 10, ["mhp"] = 15105, ["ptk"] = {4,14}, ["mtk"] = {16,28}, ["agr"] = true,
	...
	{["id"] = 116, ["name"] = "Жестокий • Сипри Соруим", ["wtype"] = 13, ["lvl"] = 30, ["atds"] = 10, ["mhp"] = 22624, ["ptk"] = {7,20}, ["mtk"] = {21,34}, ["agr"] = true,
	["daft_klz"] = {{"sp",119}}, ["tcdrop"] = 12, ["loot"] = {["exp"] = 130, ["coins"] = 60, ["items"] = "d12boss1",["drop"]={{94,20},{95,15.25},{80,5.6},{83,3.12}}},
	["skill"] = {{2,1,50},{1,1,100}}, ["vresp"] = 8^5, ["rtype"] = "e", ["image"] = "sudishesitrim"},
	{["id"] = 117, ["name"] = "Могущественный • Сипри Соруим", ["wtype"] = 13, ["lvl"] = 30, ["atds"] = 10, ["mhp"] = 31070, ["ptk"] = {11,28}, ["mtk"] = {25,45}, ["agr"] = true,
	["tcdrop"] = 12, ["loot"] = {["exp"] = 200, ["coins"] = 80, ["items"] = "d12boss1",["drop"]={{94,28.33},{95,18.31},{80,5.5},{83,3.48}}},
	["skill"] = {{2,1,50},{1,1,100}}, ["vresp"] = 8^5, ["rtype"] = "e", ["image"] = "sudishesitrim"},
	{["id"] = 118, ["name"] = "Призыв босса - Лорд Сипри", ["wtype"] = 11, ["lvl"] = 1, ["atds"] = 10, ["mhp"] = 4599,
	["daft_klz"] = {{"sp",116}}, ["cmve"] = true, ["loot"] = {["exp"] = 1, ["coins"] = 1, ["items"] = "0"},
	["skill"] = {{2,1,100}}, ["vresp"] = 8^5, ["rtype"] = "e", ["image"] = "c_ghost"},
	{["id"] = 119, ["name"] = "Призыв босса - Лорд Сипри", ["wtype"] = 11, ["lvl"] = 1, ["atds"] = 10, ["mhp"] = 7499,
	["daft_klz"] = {{"sp",117}}, ["cmve"] = true, ["loot"] = {["exp"] = 1, ["coins"] = 1, ["items"] = "0"},
	["skill"] = {{2,1,100}}, ["vresp"] = 8^5, ["rtype"] = "e", ["image"] = "c_ghost"},
	{["id"] = 120, ["name"] = "Жестокий • Вердант Соттах-Еснад", ["wtype"] = 13, ["lvl"] = 32, ["atds"] = 10, ["mhp"] = 18781, ["ptk"] = {6,18}, ["mtk"] = {18,30}, ["agr"] = true,
	["daft_klz"] = {{"sp",122}}, ["tcdrop"] = 12, ["loot"] = {["exp"] = 100, ["coins"] = 75, ["items"] = "d12boss1",["drop"]={{94,12.5},{96,1.6},{81,0.75},{83,1.99}}},
	...
	["skill"] = {{2,1,65},{1,1,100}}, ["vresp"] = 8^5, ["rtype"] = "e", ["image"] = "tlwmu"},
	{["id"] = 122, ["name"] = "Призыв босса - Соттах-Еснад", ["wtype"] = 11, ["lvl"] = 1, ["atds"] = 14, ["mhp"] = 7800,
	...
	{["id"] = 124, ["name"] = "Забытая шкатулка дре", ["lvl"] = 0, ["reqlvl"] = 15, ["rtype"] = "r", ["image"] = "chest1", ["mnprs"] = 5, ["mxprs"] = 20, ["vresp"] = 8^5,
	...
	{["id"] = 133, ["name"] = "Одвук Хивонил", ["wtype"] = "Аптекарь", ["lvl"] = 0, ["quests"] = {},
...
local gqd = {
	...
	["descr"] = "Существа, теперь населяющие некоторые пещеры, не переносят солнечного света, поэтому выходят из пещер только в ночное время суток. Теперь они все ближе и ближе подбираются к поселению в попытках найти еду.",
	["gtext"]="",
	...
	["gtext"]="Появление на юго-востоке нечистой силы говорит о серьезности атаки, а не о резком увеличении активности духов и нежити. Мы все волнуемся о частых набегах монстров.",
	...
	["descr"] = "Что же стало с духом равнины? Скорее всего силы тьмы его не просто поработили, а изменили составляющую духа. К сожалению, его нужно уничтожить, чтобы он никому не причинил вреда.",
	...
	["descr"] = "Даже до нашествия сил демонов в долине присутствовали ожившие мертвецы и природная нечисть, но теперь все монстры стали агрессивнее, а их количество увеличилось в разы. Уничтожьте предводителей сил зла в долине.",
	...
	["descr"] = "", ["qreward"] = {["coins"] = 0, ["xp"] = 500, ["item"] = nil}, ["fct"] = "setquest", ["value"] = 30},
	{["name"] = "Путеводитель (2)", ["type"] = "k", ["qr"] = 39, ["targ"] = 54, ["num"] = 1, ["minlvl"] = 1,
	["descr"] = "", ["qreward"] = {["coins"] = 0, ["xp"] = 750, ["item"] = nil}, ["fct"] = "setquest", ["value"] = 31},
	{["name"] = "Путеводитель (3)", ["type"] = "k", ["qr"] = 39, ["targ"] = 66, ["num"] = 1, ["minlvl"] = 1,
	["descr"] = "", ["qreward"] = {["coins"] = 0, ["xp"] = 1500, ["item"] = nil}, ["fct"] = "setquest", ["value"] = 32},
	{["name"] = "Путеводитель (4)", ["type"] = "k", ["qr"] = 68, ["targ"] = 76, ["num"] = 1, ["minlvl"] = 1,
	["descr"] = "", ["qreward"] = {["coins"] = 0, ["xp"] = 2250, ["item"] = nil}, ["fct"] = "setquest", ["value"] = 33},
	{["name"] = "Путеводитель (5)", ["type"] = "k", ["qr"] = 68, ["targ"] = 85, ["num"] = 1, ["minlvl"] = 1,
	["descr"] = "", ["qreward"] = {["coins"] = 0, ["xp"] = 4500, ["item"] = nil}, ["fct"] = "setquest", ["value"] = 34}, 
	{["name"] = "Путеводитель (6)", ["type"] = "k", ["qr"] = 68, ["targ"] = 104, ["num"] = 1, ["minlvl"] = 1,
	["descr"] = "", ["qreward"] = {["coins"] = 0, ["xp"] = 7500, ["item"] = nil}}, -- 34
	...
	{["name"] = "Цель: Вердант Соттах-Еснад", ["type"] = "k", ["qr"] = 68, ["targ"] = 120, ["num"] = 1, ["minlvl"] = 14,
	["descr"] = "",
	...
	{["name"] = "Способ ограничения духа", ["type"] = "k", ["qr"] = 67, ["targ"] = 121, ["num"] = 1, ["minlvl"] = 15,
	...
	["descr"] = "Недалеко от крепости вы можете найти заколдованных скелетов. Это неспроста! Нужно выяснить, мог ли ими кто-либо управлять.",
...
local gsd = {
	...
	["basedmgmlt"] = {100,100,100,100,100,100,100},
	["reqlvl"] = {1,5,10,15,20,25,30}, ["reqcn"] = {0,0,0,0,0,0,0}, ["reqitem"] = nil, 
	["manacost"] = {0,0,0,0,0,0,0}, ["eff"] = nil,["descr"] = {"Наносит базовый физический урон."}},
	{["name"] = "Глубокий порез", ["distance"] = 0, ["type"] = "attack", ["typedm"] = "p", ["lvl"] = 1, ["reloading"] = 3,
	["value"] = {5,12,21,34,51,72,100}, ["basedmgmlt"] = {100,100,100,100,100,100,100},
	...
	["basedmgmlt"] = {100,100,100,100,100,100,100},["reqlvl"] = {1,3,8,12,17,24,33}, ["reqcn"] = {0,45,82,110,146,203,295}, ["reqitem"] = {{75,1},{75,1},{75,1},{75,1},{75,1},{75,1},{75,1}},
	...
	["value"] = {10,25,43,66,91,139,194}, ["basedmgmlt"] = {100,100,100,100,100,100,100},
	["manacost"] = {7,10,13,18,24,32,42}, ["eff"] = nil,["descr"] = {"Наносит базовый физический урон, плюс $b ед.","$a урона."}},
	{["name"] = "Удар шторма", ["distance"] = 0, ["type"] = "attack", ["typedm"] = "p", ["lvl"] = 1, ["reloading"] = 10,
	["value"] = {16,34,52,88,131,186,254}, ["basedmgmlt"] = {100,100,100,100,100,100,100}, ["weapondmgmlt"] = {25,30,35,40,45,50,60},
	...
	["value"] = {22,39,65,98,152,207,292}, ["basedmgmlt"] = {100,100,100,100,100,100,100}, ["weapondmgmlt"] = {35,40,45,50,55,60,65},
...
local eusd = {
	...
	[8]={["distance"]=3,["type"]="attack",["mindamage"] = {2}, ["maxdamage"] = {5},["typedm"] = "p",["eff"]={10,1}}, -- d13 boss
	[9]={["distance"]=5,["type"]="attack",["mindamage"] = {3}, ["maxdamage"] = {12},["typedm"] = "m",["eff"]={11,1}}, -- d13 boss
}
...
local ged = {
	...
	["dur"]={5,5},["val"]={-5,-10},["i"]={0x66dbff," ",0x99dbff," ",0x66dbff," ",0x66dbff," ",0x99dbff," ",0x66dbff," "}},
...
local cPlayerSkills = {{1,0,1},{2,0,1},{3,0,1},{4,0,1},{5,0,0},{6,0,1},{7,0,0},{8,0,0},}
...
[1]={
		{	["s_name"] = "Мечи",
			{["item"]=28,["chance"]=100,["achance"]=32,["recipe"]={{2,2},{26,1},{45,2}},["cost"]=31},
			{["item"]=42,["chance"]=100,["achance"]=44,["recipe"]={{2,4},{26,2},{45,4}},["cost"]=55},
			{["item"]=59,["chance"]=100,["achance"]=56,["recipe"]={{2,6},{26,3},{45,6}},["cost"]=72},
			{["item"]=77,["chance"]=100,["achance"]=68,["recipe"]={{2,8},{26,4},{45,8}},["cost"]=125},
		},
		{	["s_name"] = "Копья",
			{["item"]=29,["chance"]=100,["achance"]=32,["recipe"]={{2,2},{21,1},{27,2}},["cost"]=25},
			{["item"]=43,["chance"]=100,["achance"]=44,["recipe"]={{2,4},{21,2},{27,4}},["cost"]=46},
			{["item"]=60,["chance"]=100,["achance"]=56,["recipe"]={{2,6},{21,3},{27,6}},["cost"]=62},
			{["item"]=78,["chance"]=100,["achance"]=68,["recipe"]={{2,8},{21,4},{27,8}},["cost"]=110},
		},
		{	["s_name"] = "Топоры",
			{["item"]=30,["chance"]=100,["achance"]=32,["recipe"]={{2,2},{27,1},{26,2}},["cost"]=55},
			{["item"]=44,["chance"]=100,["achance"]=44,["recipe"]={{2,4},{27,2},{26,4}},["cost"]=73},
			{["item"]=61,["chance"]=100,["achance"]=56,["recipe"]={{2,6},{27,3},{26,6}},["cost"]=92},
			{["item"]=79,["chance"]=100,["achance"]=68,["recipe"]={{2,8},{27,4},{26,8}},["cost"]=136},
		},
		{	["s_name"] = "Кольца",
			{["item"]=65,["chance"]=100,["achance"]=45,["recipe"]={{2,2},{26,2},{45,2}},["cost"]=46},
			{["item"]=123,["chance"]=100,["achance"]=55,["recipe"]={{2,3},{26,4},{45,3}},["cost"]=70},
		},
		{	["s_name"] = "Кулоны",
			{["item"]=35,["chance"]=100,["achance"]=45,["recipe"]={{2,1},{19,1},{45,1}},["cost"]=60},
			{["item"]=41,["chance"]=100,["achance"]=55,["recipe"]={{2,2},{19,3},{45,2}},["cost"]=87},
			{["item"]=74,["chance"]=100,["achance"]=65,["recipe"]={{2,3},{19,5},{45,3}},["cost"]=110},
		},
		{	["s_name"] = "Переплавка",
			{["item"]=87,["chance"]=100,["achance"]=0,["recipe"]={{27,1},{2,1},{21,1},{26,1}},["cost"]=0},
		},
		
	},
[2]={
		{	["s_name"] = "Голова",
			{["item"]=31,["chance"]=100,["achance"]=35,["recipe"]={{20,2},{2,1},{19,1}},["cost"]=20},
			{["item"]=37,["chance"]=100,["achance"]=45,["recipe"]={{20,3},{2,2},{19,2}},["cost"]=32},
			{["item"]=70,["chance"]=100,["achance"]=55,["recipe"]={{20,5},{2,4},{19,3}},["cost"]=54},
			{["item"]=99,["chance"]=100,["achance"]=65,["recipe"]={{46,1},{118,1},{120,1},{122,1}},["cost"]=81},
		},
		{	["s_name"] = "Корпус",
			{["item"]=32,["chance"]=100,["achance"]=35,["recipe"]={{2,2},{20,2},{18,1}},["cost"]=26},
			{["item"]=38,["chance"]=100,["achance"]=45,["recipe"]={{2,2},{20,3},{18,2}},["cost"]=45},
			{["item"]=71,["chance"]=100,["achance"]=55,["recipe"]={{2,3},{20,4},{18,3}},["cost"]=80},
			{["item"]=100,["chance"]=100,["achance"]=65,["recipe"]={{46,1},{118,1},{120,1},{122,1}},["cost"]=102},
		},
		{	["s_name"] = "Брюки",
			{["item"]=33,["chance"]=100,["achance"]=35,["recipe"]={{2,2},{20,2},{18,1}},["cost"]=24},
			{["item"]=39,["chance"]=100,["achance"]=45,["recipe"]={{2,2},{20,3},{18,2}},["cost"]=40},
			{["item"]=72,["chance"]=100,["achance"]=55,["recipe"]={{2,3},{20,4},{18,3}},["cost"]=72},
			{["item"]=101,["chance"]=100,["achance"]=65,["recipe"]={{46,1},{118,1},{120,1},{122,1}},["cost"]=91},
		},
		{	["s_name"] = "Обувь",
			{["item"]=34,["chance"]=100,["achance"]=35,["recipe"]={{2,2},{20,1},{19,2}},["cost"]=24},
			{["item"]=40,["chance"]=100,["achance"]=45,["recipe"]={{2,3},{20,2},{19,3}},["cost"]=42},
			{["item"]=73,["chance"]=100,["achance"]=55,["recipe"]={{2,4},{20,3},{19,4}},["cost"]=72},
			{["item"]=102,["chance"]=100,["achance"]=65,["recipe"]={{46,1},{118,1},{120,1},{122,1}},["cost"]=88},
		},
		{	["s_name"] = "Плащ",
			{["item"]=64,["chance"]=100,["achance"]=35,["recipe"]={{20,2},{18,2},{19,2}},["cost"]=38},
			{["item"]=76,["chance"]=100,["achance"]=50,["recipe"]={{20,4},{18,4},{19,4}},["cost"]=85},
			{["item"]=98,["chance"]=100,["achance"]=65,["recipe"]={{117,2},{118,1},{120,1},{122,1}},["cost"]=142},
		},
	},
[3]={
		{	["s_name"] = "Алхимик",
			{["item"]=53,["chance"]=100,["achance"]=0,["recipe"]={{54,2}},["cost"]=37},
			{["item"]=55,["chance"]=100,["achance"]=0,["recipe"]={{53,3}},["cost"]=63},
		},	
	},
[4]={
		{	["s_name"] = "Меч",
			{["item"]=84,["chance"]=100,["achance"]=91.7,["recipe"]={{82,2},{52,2},{50,2},{83,1},{87,1}},["cost"]=67},
			{["item"]=91,["chance"]=100,["achance"]=91.7,["recipe"]={{94,10},{52,2},{83,1},{87,2}},["cost"]=99},
		},
		{	["s_name"] = "Копье",
			{["item"]=85,["chance"]=100,["achance"]=91.7,["recipe"]={{82,2},{52,2},{50,2},{83,1},{87,1}},["cost"]=67},
			{["item"]=92,["chance"]=100,["achance"]=91.7,["recipe"]={{94,10},{52,2},{83,1},{87,2}},["cost"]=99},
		},
		{	["s_name"] = "Топор",
			{["item"]=86,["chance"]=100,["achance"]=91.7,["recipe"]={{82,2},{52,2},{50,2},{83,1},{87,1}},["cost"]=67},
			{["item"]=93,["chance"]=100,["achance"]=91.7,["recipe"]={{94,10},{52,2},{83,1},{87,2}},["cost"]=99},
		},
		{	["s_name"] = "Кольцо",
			{["item"]=88,["chance"]=100,["achance"]=92.4,["recipe"]={{80,1},{51,1},{50,2},{83,1},{87,1}},["cost"]=52},
		},
		{	["s_name"] = "Кулон",
			{["item"]=89,["chance"]=100,["achance"]=92.4,["recipe"]={{80,1},{51,1},{50,2},{83,1},{87,1}},["cost"]=55},
		},
		{	["s_name"] = "Переплавка",
			{["item"]=87,["chance"]=100,["achance"]=0,["recipe"]={{27,1},{2,1},{21,1},{26,1}},["cost"]=0},
			{["item"]=87,["chance"]=100,["achance"]=0,["recipe"]={{51,1},{52,1}},["cost"]=50},
		},	
	},
[5]={
		{	["s_name"] = "Снаряжение",
			{["item"]=104,["chance"]=100,["achance"]=100,["recipe"]={{94,2},{87,2},{96,1}},["cost"]=109},
			{["item"]=106,["chance"]=100,["achance"]=100,["recipe"]={{94,2},{87,2},{95,1}},["cost"]=109},
			{["item"]=108,["chance"]=100,["achance"]=100,["recipe"]={{94,2},{87,2},{95,1}},["cost"]=109},
			{["item"]=110,["chance"]=100,["achance"]=100,["recipe"]={{94,2},{87,2},{95,1}},["cost"]=109},
		},
		{	["s_name"] = "Улучшенное снаряжение",
			{["item"]=105,["chance"]=100,["achance"]=0,["recipe"]={{94,8},{87,5},{95,3}},["cost"]=199},
			{["item"]=107,["chance"]=100,["achance"]=0,["recipe"]={{94,8},{87,5},{97,3}},["cost"]=199},
			{["item"]=109,["chance"]=100,["achance"]=0,["recipe"]={{94,8},{87,5},{96,3}},["cost"]=199},
			{["item"]=111,["chance"]=100,["achance"]=0,["recipe"]={{94,8},{87,5},{95,3}},["cost"]=199},
		},
	},	
}
...
local function scolorText(x,y,col,str)
local dsymb = "^"
...
function gfunc.textWrap(text,length)
local u, h, n, anchor = {}, 1, 1, nil
local cn
 while true do
 if not u[h] then u[h] = {} end
 cn = #u[h]
  for f = 1, length-cn do
   if unocode.sub(text,h*length-length+f+cn,h*length-length+f+cn) ~= " " then
   u[h][f+cn] = unocode.sub(text,h*length-length+f+cn,h*length-length+f+cn)
   else
   u[h][f+cn] = " "
   anchor = f+cn
   end
  ...
  if u[h][length] ~= " " then
  u[h+1] = {}
   for f = anchor, length do
   u[h+1][anchor-f+1] = u[h][f]
   u[h][f] = " "
   end
  end
 h = h + 1
...
local cQue = gud[cGUData[id]["id"]]["quests"]
local insQuestDialog = true 
 if type(cQue) == "table" and cDialog["im"] ~= nil then
  ...
  var = true
   for q = 1, #cUquests do
    if cUquests[q][1] == cQue[f] and cUquests[q][3] then
     if cGUData[1]["lvl"] < gqd[cQue[f]]["minlvl"] or gqd[cQue[f]]["comp"] or not gqd[cQue[f]]["comp"] then
	 var = false
     break
	 end
    end
  ...
  for f = 1, #cUquests do
   if cUquests[f][3] and cGUData[cTarget]["id"] == gqd[cUquests[f][1]]["qr"] and newDialog[1]["dq"]~=nil then
...
cGUData[#cGUData]["x"] = x
cGUData[#cGUData]["y"] = y
cGUData[#cGUData]["id"] = gud[id]["id"]
cGUData[#cGUData]["lvl"] = gud[id]["lvl"]
cGUData[#cGUData]["spos"] = "r"
cGUData[#cGUData]["image"] = 0
 if cGUData[#cGUData]["image"] ~= nil then
 cUSprite = image.load(cpath.."sprpic/"..gud[id]["image"]..".pic")
 cGUData[#cGUData]["width"] = cUSprite.width
 cGUData[#cGUData]["height"] = cUSprite.height
 end
 cUSprite = nil
 if gud[id]["mhp"] == nil then
 cGUData[#cGUData]["mhp"] = math.ceil(36+(gud[id]["lvl"]-1)*36.3+((gud[id]["lvl"]-1)^2-1)/2)
 else
 cGUData[#cGUData]["mhp"] = gud[id]["mhp"]
 end
 if gud[id]["hpmul"] then
 cGUData[#cGUData]["mhp"] = math.ceil(cGUData[#cGUData]["mhp"] * gud[id]["hpmul"])
 end
cGUData[#cGUData]["chp"] = cGUData[#cGUData]["mhp"]
if not gud[id]["ptk"] then cGUData[#cGUData]["ptk"] = {
math.ceil(cGUData[#cGUData]["lvl"]*1.25+cGUData[#cGUData]["lvl"]^0.2),
math.ceil(cGUData[#cGUData]["lvl"]*1.42+cGUData[#cGUData]["lvl"]^0.6)
}
else cGUData[#cGUData]["ptk"] = gud[id]["ptk"] end
if not gud[id]["mtk"] then cGUData[#cGUData]["mtk"] = {
math.ceil(cGUData[#cGUData]["lvl"]*1.38+cGUData[#cGUData]["lvl"]^0.2),
math.ceil(cGUData[#cGUData]["lvl"]*1.52+cGUData[#cGUData]["lvl"]^0.6)
} 
else cGUData[#cGUData]["mtk"] = gud[id]["mtk"] end
cGUData[#cGUData]["pdef"] = 0
cGUData[#cGUData]["mdef"] = 0
cGUData[#cGUData]["resptime"] = 0
cGUData[#cGUData]["living"] = true
cGUData[#cGUData]["cmove"] = true
cGUData[#cGUData]["ctck"] = true
cGUData[#cGUData]["rtype"] = gud[id]["rtype"]
cGUData[#cGUData]["attPlayer"] = false
cGUData[#cGUData]["tlinfo"] = {}
 if gud[id]["rtype"] == "f" then 
 cGUData[#cGUData]["dialog"] = gud[id]["dialog"]
 end
cGUData[#cGUData]["effects"] = {}
console.debug("Добавление","id:"..tostring(gud[id]["id"]),"имя:"..gud[id]["name"],"x:"..tostring(x),"y:"..tostring(y),"Gid:"..#cGUData)
end
 ...
 if not gid[itemid] or not gid[itemid]["stackable"] then
  for f = 1, #inventory["bag"] do
   ...
   inventory["bag"][f][2] = num
	...
	iconImageBuffer[f] = image.load(cpath.."itempic/"..aItemIconsSpr[gid[inventory["bag"][f][1]]["icon"]]..".pic")
    end
   r = f
   break 
   end
 ...
 if gid[itemid] and gid[itemid]["stackable"] and vparInvEx == 0 then
  ...
  if vparInvEx == 0 then
   for i = 1, #inventory["bag"] do
	...
	vparInvEx = 1
    if cWindowTrd == "inventory" then
	iconImageBuffer[i] = image.load(cpath.."itempic/"..aItemIconsSpr[gid[inventory["bag"][i][1]]["icon"]]..".pic")
    end	
	r = i
	break
	end
...
local new = {}
 ...
 for f = 1, #massiv do
 table.insert(new,math.random(1,#massiv),massiv[f])
 end
...
gid[newItemID]["props"] = {["dds"]={}}
 ...
 local props = {
	...
	[9]={"pdf+",
		["min"] = (gid[itemID]["lvl"]-1)^2,
		["max"] = (gid[itemID]["lvl"]-1)^2*5,
		["weapon"] = 0,
 ...
 local adnum = 1
 for f = 1, 5 do
  if math.random(1,10^4)/100 <= ddch[6-f] then
  adnum = 6-f
  break
  end
 end
 ...
 local dt, value
  ...
  cccc = false
   dt = math.random(1,#props)
   if math.random(1,10^5) <= props[dt][gid[itemID]["type"]]*10^3 then
   value = math.floor(math.random(props[dt]["min"]*10,props[dt]["max"]*10)/10)
...
-- for f = 1, 20 do addItem(createNewItem(math.random(1,116)),math.random(1,10)) end
-- addItem(90,1)
-- addItem(103,1)
-- addItem(105,1)
-- addItem(107,1)
...
-- addItem(112,1)
-- local ym0 = {98}
-- for f = 1, 20 do addItem(createNewItem(ym0[math.random(1,#ym0)]),1) end
...
local addne = true 
 if type(id) == 'number' and type(lvl) == 'number' and id >= 1 and id <= #ged then
  for eff = 1, #cGUData[1]["effects"] do
   ...
   cGUData[1]["effects"][eff][2] = ged[id]["dur"][lvl]
   addne = false
   break
   end
  end
 if addne then table.insert(cGUData[1]["effects"],{id,ged[id]["dur"][lvl],lvl}) end
 else
...
local addne = true 
 if uID ~= nil and eID ~= nil and lvl ~= nil and eID >= 1 and eID <= #ged then
  ...
  for eff = 1, #cGUData[uID]["effects"] do
   ...
   cGUData[uID]["effects"][eff][2] = ged[eID]["dur"][lvl]
   addne = false
   break
   end
  end
 if addne then table.insert(cGUData[uID]["effects"],{eID,ged[eID]["dur"][lvl],lvl}) end
 else
 console.wError('addUnitEffect: неверное значение uID, eID или lvl')
 end
end

local function inderttunitinfo(u,text)
table.insert(cGUData[u]["tlinfo"],text)
end
...
local v = {vSur=0,vStr=0,vInt=0,vHpi=0,vPdm1=0,vMdm1=0,vPdm2=0,vMdm2=0,vPdf=0,vMdf=0,vpdf=0,vmdf=0, vaPdm=0, vaMdm=0, vMpi=0, vCritChan=0, hppc=0, mppc=0}
cGUData[1]["mhp"], mmp, mxp, cGUData[1]["ptk"], cGUData[1]["mtk"], cGUData[1]["pdef"], cGUData[1]["mdef"] = 0, 0, 0, 0, 0, 0, 0
local witypes = {
	"helmet",
	"pendant",
	"bodywear",
...
local buben
 for f = 1, #witypes do
  ...
  buben = gid[inventory["weared"][witypes[f]]]["props"]["dds"]
   for e = 1, #buben do
    if buben[e][1] == "sur+" then v.vSur = v.vSur + buben[e][2]
    elseif buben[e][1] == "str+" then v.vStr = v.vStr + buben[e][2]
	elseif buben[e][1] == "int+" then v.vInt = v.vInt + buben[e][2]
	elseif buben[e][1] == "hp+" then v.vHpi = v.vHpi + buben[e][2]
	elseif buben[e][1] == "pdm+" then v.vPdm1, v.vPdm2 = v.vPdm1 + buben[e][2], v.vPdm1 + buben[e][2]
	elseif buben[e][1] == "mdm+" then v.vMdm1, v.vMdm2 = v.vMdm1 + buben[e][2], v.vMdm1 + buben[e][2]
	elseif buben[e][1] == "pdf+" then v.vPdf = v.vPdf + buben[e][2]
	elseif buben[e][1] == "mdf+" then v.vMdf = v.vMdf + buben[e][2]
    elseif buben[e][1] == "mp+" then v.vMpi = v.vMpi + buben[e][2]
	elseif buben[e][1] == "chc+" then v.vCritChan = v.vCritChan + buben[e][2]
	elseif buben[e][1] == "hp%" then v.hppc = v.hppc + buben[e][2]
	elseif buben[e][1] == "mp%" then v.mppc = v.mppc + buben[e][2]
	end  
   end   
  end
  if inventory["weared"][witypes[f]] ~= 0 and gid[inventory["weared"][witypes[f]]]["type"] == "armor" then
  v.vPdf = v.vPdf + gid[inventory["weared"][witypes[f]]]["props"]["pdef"]
  v.vMdf = v.vMdf + gid[inventory["weared"][witypes[f]]]["props"]["mdef"] 
  end 
 end
 --
 local vAtds = 8 
 CritChan = 1+math.floor((strength+v.vStr)/10)
 CritChan = CritChan+math.floor((intelligence+v.vInt)/10)
...
vaddsPnts.vSur, vaddsPnts.vStr, vaddsPnts.vInt, vaddsPnts.vPdm1, vaddsPnts.vMdm1, vaddsPnts.vPdm2, vaddsPnts.vMdm2 = v.vSur, v.vStr, v.vInt, v.vPdm1, v.vMdm1, v.vPdm2, v.vMdm2
cGUData[1]["mhp"] = math.ceil(((45+(survivability+v.vSur)*15+(cGUData[1]["lvl"]-1)*28+v.vHpi))*(1+v.hppc/100))
mmp = math.ceil(((28+(intelligence+v.vInt)*6+(cGUData[1]["lvl"]-1)*7+v.vMpi))*(1+v.mppc/100))
local reqxp = 0
 for e = 1, cGUData[1]["lvl"] do
  if e <= 15 then
...
mxp = reqxp
cGUData[1]["ptk"] = {
math.floor(1+(1+4*(strength+v.vStr)/100)*(cGUData[1]["lvl"]+v.vPdm1)),
math.ceil(1+(1+4*(strength+v.vStr)/100)*(cGUData[1]["lvl"]+v.vPdm2))
}
cGUData[1]["mtk"] = {
math.floor(1+(1+4*(intelligence+v.vInt)/100)*(cGUData[1]["lvl"]+v.vMdm1)),
math.ceil(1+(1+4*(intelligence+v.vInt)/100)*(cGUData[1]["lvl"]+v.vMdm2))
}
cGUData[1]["pdef"] = math.floor(15+((survivability+v.vSur)/2+(strength+v.vStr)/4)*(cGUData[1]["lvl"]*5+v.vPdf/2))
cGUData[1]["armorpdef"] = v.vPdf
cGUData[1]["mdef"] = math.floor(15+((survivability+v.vSur)/2+(intelligence+v.vInt)/4)*(cGUData[1]["lvl"]*5+v.vMdf/2))
--math.ceil(15+(survivability+v.vSur)*33.6+(strength+v.vStr)*41.4+(-1)*9.85)+
--math.ceil(15+(survivability+v.vSur)*24.3+(intelligence+v.vInt-1)*30.8+(cGUData[1]["lvl"]-1)*9.4)+v.vMdf
cGUData[1]["armormdef"] = v.vMdf
cGUData[1]["cmove"] = true
cGUData[1]["ctck"] = true
cGUData[1]["criticalhc"] = v.vCritChan + CritChan
...
cGUData[1]["x"], cGUData[1]["mx"], cGlobalx, cBackgroundPos = 1, 1, 1, 1
local n = cGUData[1]
cGUData = {}
cGUData[1] = n
cGUData[1]["cmove"] = true
cGUData[1]["ctck"] = true
imageBuffer = {[-1]=image.load(cpath.."sprpic/player_pck.pic"),[0]=image.load(cpath.."sprpic/player.pic")}
local cspawnl = world[id].spawnList
local bufferenv = 0
local spx, npx = 0, 0
local function a(f) imageBuffer[f] = image.duplicate(image.load(cpath.."sprpic/"..gud[cspawnl[f][1]]["image"]..".pic")) end
...
gpu.setForeground(0xCCCCCC)
 ...
 term.setCursor(5,40) 
 io.write(string.rep("█",math.floor(f*150/#cspawnl)))
 os.sleep()
 end
paused = false
stopDrawing = false
...
local x = x or 1
cGlobalx, cBackgroundPos, cGUData[1]["x"], cGUData[1]["mx"] = x, x, x, x
end
...
cGUData[1]["chp"] = math.floor(cGUData[1]["chp"])
local f = io.open(savePath.."/"..filename, "w")
f:write(os.date(),"\n") -- дата изм
f:write(ser.serialize(cGUData[1]),"\n") -- игрок
...
gd = {}
 for i = 1, #cGUData do
 gd[i] = {cGUData[i]["living"],cGUData[i]["resptime"]} 
 end
...
local function loadGame(savePath,filename)
 ...
 strength = yv[9]
 intelligence = yv[10]
 cGUData[1] = ser.unserialize(tbl[2])
 local buben = cGUData[1]["x"]
 ...
 yv = ser.unserialize(tbl[10])
  for f = 1, #yv do
   if cGUData[f] then
   cGUData[f]["living"], cGUData[f]["resptime"] = yv[f][1], yv[f][2]
   if yv[f][3] then gud[cGUData[f]["id"]]["nres"] = false end
   end
  end
...
local sdq = false
 if id > 0 and gud[id]["quests"] then
  for f = 1, #gud[id]["quests"] do
   if gqd[gud[id]["quests"][f]] and gqd[gud[id]["quests"][f]]["comp"] == 0 and cGUData[1]["lvl"] >= gqd[gud[id]["quests"][f]]["minlvl"] then
   sdq = true
   break
   end
  end
...
local subtextninfo
 for f = 2, #cGUData do
  cx, cy = math.floor(cGUData[f]["x"]), math.floor(cGUData[f]["y"])
  if cGUData[f]["living"] and getDistanceToId(1,f) <= 75 then  
   if cGUData[f]["image"] ~= nil and cGUData[f]["spos"] == "r" then
   buffer.image(cx+75-cGlobalx,49-cy-cGUData[f]["height"], imageBuffer[cGUData[f]["image"]])
   elseif cGUData[f]["image"] ~= nil and cGUData[f]["spos"] == "l" then
   buffer.image(cx+75-cGlobalx,49-cy-cGUData[f]["height"], image.flipHorizontal(image.duplicate(imageBuffer[cGUData[f]["image"]])))
   else buffer.text(cx+75-cGlobalx,49-cy-cGUData[f]["height"],0xcc2222,"ERROR")
   end
 
   if ( cGUData[f]["rtype"] == "e" or cGUData[f]["rtype"] == "p" or cGUData[f]["rtype"] == "m" ) and cTarget == f then
   pbar(cx+75-cGlobalx+math.floor((cGUData[f]["width"]/2-8/2)), 49-cy-2-cGUData[f]["height"],8,math.ceil(cGUData[f]["chp"])*100/cGUData[f]["mhp"],0xFF0000,0x444444," ",0xFFFFFF)
   buffer.text(math.floor(cx+75-cGlobalx+(cGUData[f]["width"]/2-8/2)+(math.floor((8 / 2) - (unicode.len(tostring(math.ceil(cGUData[f]["chp"]))) / 2)))),49-cy-2-cGUData[f]["height"],0xFFFFFF,tostring(math.ceil(cGUData[f]["chp"])))
   local btname = gud[cGUData[cTarget]["id"]]["name"]
   if unicode.len(tostring(btname)) >= 24 then btname = unicode.sub(btname,1,24).."…" end
   buffer.text(math.floor(cx+75-cGlobalx+(cGUData[f]["width"]/2-24/2)+(math.floor((24 / 2) - (unicode.len(btname) / 2)))),49-cy-3-cGUData[f]["height"],0xFFFFFF,btname)
   ...
   pbar(cx+75-cGlobalx+math.floor((cGUData[f]["width"]/2-8/2)),49-cy-cGUData[f]["height"]-2,8,vpercentr,0x009945,0x444444,vpercentr.."% ",0xFFFFFF)
   
   elseif cGUData[f]["rtype"] == "f" then
    if gfunc.check_npc_cq(cGUData[f]["id"]) == true then
	ccl = 0x009922
	elseif gfunc.check_npc_dq(cGUData[f]["id"]) == true then
	ccl = 0xDCBC12
	end
    if ccl then
	buffer.text(cx+75-cGlobalx+math.floor((cGUData[f]["width"]/2))-2,49-cy-cGUData[f]["height"]-3,ccl,"▔██▔")
    buffer.text(cx+75-cGlobalx+math.floor((cGUData[f]["width"]/2))-1,49-cy-cGUData[f]["height"]-2,ccl,"◤◥")   
    ccl = nil
	end
   end
  end
  ...
  subtextninfo = ""
   for m = 1, 2 do
    if cGUData[f]["tlinfo"][m] then
    subtextninfo = cGUData[f]["tlinfo"][m]
    if unicode.len(tostring(cGUData[f]["tlinfo"][m])) >= 24 then subtextninfo = unicode.sub(cGUData[f]["tlinfo"][m][1],1,24).."…" end
    buffer.text(math.floor(cx+75-cGlobalx+(cGUData[f]["width"]/2-24/2)+(math.floor((24 / 2) - (unicode.len(subtextninfo) / 2)))),49-cGUData[f]["y"]-3-m-cGUData[f]["height"],0xFFFFFF,subtextninfo)
    end
   end
  end
 end
...
cTarget = 0
 ...
 for f = 2, #cGUData do
  if clicked(x, y, math.floor(cGUData[f]["x"])+75-cGlobalx, 49-math.floor(cGUData[f]["y"])-2-cGUData[f]["height"], math.floor(cGUData[f]["x"])+75-cGlobalx+cGUData[f]["width"], 49-math.floor(cGUData[f]["y"])) then
   if cGUData[f]["living"] then 
   cTarget = f 
   console.debug("Выбрать цель","id:",tostring(cTarget),gud[cGUData[cTarget]["id"]]["name"])
   end
  end
 end
end
...
buffer.text(x+1, y, 0xFFFFFF, "Уровень "..cGUData[1]["lvl"])
...
if svxpbar then buffer.text(x+25-#fxpdt, y+3, 0x4F4F4F, fxpdt) end
 for f = 1, #cGUData[1]["effects"] do
  for h = 1, 2 do
   for w = 1, 3 do
   buffer.square(x+f*4-4+w,y+5+h,1,1,ged[cGUData[1]["effects"][f][1]]["i"][2*(3*(h-1)+w)-1],0xFFFFFF,ged[cGUData[1]["effects"][f][1]]["i"][2*(3*(h-1)+w)])
   end
  end
 end
 if vshowEffDescr ~= 0 and cGUData[1]["effects"][vshowEffDescr]then
  buffer.square(sEffdx,sEffdy,math.max(unicode.len(ged[cGUData[1]["effects"][vshowEffDescr][1]]["name"]),unicode.len(ged[cGUData[1]["effects"][vshowEffDescr][1]]["descr"])),2,0xA1A1A1,0xFFFFFF," ")
  buffer.text(sEffdx,sEffdy,0xEDEDED,ged[cGUData[1]["effects"][vshowEffDescr][1]]["name"])
  buffer.text(sEffdx,sEffdy+1,0xCECECE,ged[cGUData[1]["effects"][vshowEffDescr][1]]["descr"])
 end
end
...
local cwtype = ""
if type(gud[cGUData[cTarget]["id"]]["wtype"]) == "number" then
cwtype = baseWtype[gud[cGUData[cTarget]["id"]]["wtype"]]
else
cwtype = gud[cGUData[cTarget]["id"]]["wtype"]
end
local sTInfoArray1 = {
	unicode.sub(gud[cGUData[cTarget]["id"]]["name"],1,23),
	"Тип: "..unicode.sub(tostring(cwtype),1,18),
	"Респ: "..tostring(gud[cGUData[cTarget]["id"]]["vresp"]).." секунд",
	"ID: "..tostring(cGUData[cTarget]["id"]),
}
local sTInfoArray2 = {
	"Физ.атака: "..cGUData[cTarget]["ptk"][1].."-"..cGUData[cTarget]["ptk"][2],
	"Маг.атака: "..cGUData[cTarget]["mtk"][1].."-"..cGUData[cTarget]["mtk"][2],
	"Физ.защита: "..tostring(cGUData[cTarget]["pdef"].." ("..tostring(math.floor(100*(cGUData[cTarget]["pdef"]/(cGUData[cTarget]["pdef"]+cGUData[1]["lvl"]*30)))).."%)"),
	"Маг.защита: "..tostring(cGUData[cTarget]["mdef"].." ("..tostring(math.floor(100*(cGUData[cTarget]["mdef"]/(cGUData[cTarget]["mdef"]+cGUData[1]["lvl"]*30)))).."%)"),
}
buffer.square(x, y, 25, 9, 0xABABAB, 0xFFFFFF, " ")
 for f = 1, #sTInfoArray1 do
 buffer.text(x+1,y+f-1,0xFFFFFF,tostring(sTInfoArray1[f]))
 end
 if cGUData[cTarget]["rtype"] ~= "f" and cGUData[cTarget]["rtype"] ~= "c" then
...
local namecolor, clvl, plvl = 0xFFFFFF, cGUData[cTarget]["lvl"], cGUData[1]["lvl"]
...
local pbtext, lbtext = gud[cGUData[cTarget]["id"]]["name"], tostring(cGUData[cTarget]["lvl"]).." уровень"
...
local pntext, lbtext = gud[cGUData[cTarget]["id"]]["wtype"], gud[cGUData[cTarget]["id"]]["name"]
...
buffer.text(x + (math.max(math.floor((35 / 2) - (unicode.len(gud[cGUData[cTarget]["id"]]["name"]) / 2)), 0)), y+1, 0xFFFFFF, gud[cGUData[cTarget]["id"]]["name"])
buffer.text(x + (math.max(math.floor((35 / 2) - (unicode.len(pntext) / 2)), 0)), y+2, 0x727272, pntext)
bl = false
elseif cGUData[cTarget]["rtype"] == "c" then
...
if bl then buffer.text(x+1,y+3,0xFFFFFF,"О персонаже") end
 for f = 1, #cGUData[cTarget]["effects"] do
  for h = 1, 2 do
   for w = 1, 3 do
   buffer.square(x+f*4-4+w,y+4+h,1,1,ged[cGUData[cTarget]["effects"][f][1]]["i"][2*(3*(h-1)+w)-1],0xFFFFFF,ged[cGUData[cTarget]["effects"][f][1]]["i"][2*(3*(h-1)+w)])
   end
  end
 end
 ...
 for f = 1, #cDialog do
  ...
  if cDialog[#cDialog-f+1] ~= nil then
   ...
   if cDialog[#cDialog-f+1] ~= nil and cDialog[#cDialog-f+1]["action"] == "qdialog" then
    if isQnComp or gqd[cDialog[#cDialog-f+1]["q"]]["minlvl"] > cGUData[1]["lvl"] or gqd[cDialog[#cDialog-f+1]["q"]]["comp"] == true then
    table.remove(cDialog,#cDialog-f+1)
    end
   elseif cDialog[#cDialog-f+1]["action"] == "setWorld" and cGUData[1]["lvl"] < cDialog[#cDialog-f+1]["reqlvl"] then
...
local text1 = gud[cGUData[cTarget]["id"]]["name"]
...
giiwcAdd(gid[id]["name"], gid[id]["ncolor"])
 ...
 if itemtype == "armor" or itemtype == "weapon" or itemtype == "potion" then
  ...
  if gid[id]["reqlvl"] > cGUData[1]["lvl"] then
  ...
  formula = (f-1)*5+i
   if inventory["bag"][formula][1] ~= 0 and inventory["bag"][formula][2] ~= 0 then    
    if iconImageBuffer[formula] then
	 ...
	 buffer.image(xps, yps, image.load(cpath.."image/itemnotex.pic"))
	 end
    else
...
local textRemoveItem = "Выбросить предмет(ы)"
 ...
 buffer.square(math.min(invIdx,160-w), math.min(invIdy,50-h), w, h, 0x828282, 0xFFFFFF, " ")
  for f = 1, #itemInfo do
  scolorText(math.min(invIdx,160-w),math.min(invIdy+f-1,50-h+f-1),itemInfo[f][2],itemInfo[f][1])
  end
...
buffer.text(x+119, y+2,0xFFFFFF,hclr[tradew.torg])
 ...
 local t1
  ...
  t1 = unicode.sub(gameTradew[tradew.twindow][f]["s_name"],1,25)
 ...
 local blblb = string.rep("─",158)
  for f = 1, math.min(#massiv+1, 24) do
  buffer.text(x+1,y+4+f*2-2,0xFFFFFF,blblb)
  end
 blblb = nil
  for f = 1, math.min(#massiv, 24) do
...
local massiv = gameCraftw[craftw.twindow][craftw.sect]
local t1
 for f = 1, #gameCraftw[craftw.twindow] do
 t1 = unicode.sub(gameCraftw[craftw.twindow][f]["s_name"],1,25)
...
local ydd = {
	...
	[1]={
		"Продолжить",
		f=function()
		local xpdec = math.floor(mxp*math.random(2*(10/math.sqrt(cGUData[1]["lvl"]))*100,5*(10/math.sqrt(cGUData[1]["lvl"]))*100)*0.0001)
		 for f=1,#inventory["bag"] do
...
function gfunc.remFirstSmfromString(str,cs)
...
buffer.square(x+32, y+2, 66, 27, 0x7A7A7A, 0xFFFFFF, " ")
 ...
 local dstr
  ...
  dstr = gfunc.remFirstSmfromString(gfunc.remFirstSmfromString(unicode.sub(gqd[cUquests[targetQuest][1]]["descr"],1+(60*i-60),60*i),",")," ")
...
buffer.text(x+92,y,0xFFFFFF,"Закрыть")
local info1 = {
	"Имя персонажа: "..gud[cGUData[1]["id"]]["name"],
	"Уровень: "..cGUData[1]["lvl"],
	...
	"Физическая атака: "..cGUData[1]["ptk"][1].."-"..cGUData[1]["ptk"][2].." ("..math.ceil((vaddsPnts.vPdm1+vaddsPnts.vPdm2)/2).." от снаряжения)",
	"Магическая атака: "..cGUData[1]["mtk"][1].."-"..cGUData[1]["mtk"][2].." ("..math.ceil((vaddsPnts.vMdm1+vaddsPnts.vMdm2)/2).." от снаряжения)",
	"Физическая защита: "..cGUData[1]["pdef"].." ("..cGUData[1]["armorpdef"].." от снаряжения)",
	"Магическая защита: "..cGUData[1]["mdef"].." ("..cGUData[1]["armormdef"].." от снаряжения)",
	"Вероятность нанесения критического удара: "..cGUData[1]["criticalhc"].."%",
...
local blbl, abc, rv
 ...
 blbl = gsd[cPlayerSkills[skillstr.targ][1]] 
  if cPlayerSkills[skillstr.targ][3] < #blbl["manacost"] then
   ...
   if blbl["reqlvl"][cPlayerSkills[skillstr.targ][3]+1] > cGUData[1]["lvl"] then buben[#buben][2] = 0xEE1414 end
   end
   if blbl["reqcn"] then
 ...
 if slvl > 0 then
  ...
  if blbl["basedmgmlt"] then rv[3] = blbl["basedmgmlt"][slvl] else rv[3] = "" end
 ...
 buffer.text(x+54,y+4,0xFFFFFF,"Тип "..stypes[blbl["type"]])
  ...
  buffer.text(x+54,y+5,0xCCCCCC,"Умение еще не изучено")
  end
  if slvl > 0 then
   abc = {
   }
...
cGUData[id]["resptime"] = gud[cGUData[id]["id"]]["vresp"]
end

local function spawnSingleUnit(id,x,y)
addUnit(id,x,y)
imageBuffer[#imageBuffer+1] = image.duplicate(image.load(cpath.."sprpic/"..gud[id]["image"]..".pic"))
cGUData[#cGUData]["image"] = #imageBuffer
end
...
local function dAfterkill(d,x)
 for f = 1, #d do
  if d[f] == "np" then
  addUnit(43,x+10,2)
  imageBuffer[#imageBuffer+1] = image.duplicate(image.load(cpath.."sprpic/"..gud[43]["image"]..".pic"))
  cGUData[#cGUData]["image"] = #imageBuffer
  elseif type(d[f]) == "table" and d[f][1] == "sp" then
  spawnSingleUnit(d[f][2],x+math.random(-10,10),1)
...
local eeee
local chchance = 1
if math.random(1,100) <= cGUData[1]["criticalhc"] then chchance = 2; damage = damage * 2 end
 if cGUData[id]["chp"] > damage then
 cGUData[id]["attPlayer"] = true
 cGUData[id]["chp"] = cGUData[id]["chp"] - damage
 console.debug("Урон нанесен персонажу",unicode.sub(gud[cGUData[id]["id"]]["name"],1,15),tostring(damage):sub(1,5))
 ...
 cGUData[id]["resptime"] = gud[cGUData[id]["id"]]["vresp"]
  for f = 1, #cUquests do
   if type(cUquests[f][2]) == "number" then
    if cGUData[id]["id"] == gqd[cUquests[f][1]]["targ"] and cUquests[f][3] == false then
   ...
   elseif gqd[cUquests[f][1]]["type"] == "k" and type(cUquests[f][2]) == "table" then
	for j = 1, #gqd[cUquests[f][1]]["targ"] do
	 if cGUData[id]["id"] == gqd[cUquests[f][1]]["targ"][j] and cUquests[f][3] == false then
 ...
 local expr = gud[cGUData[id]["id"]]["loot"]["exp"]+math.ceil(math.random(-gud[cGUData[id]["id"]]["loot"]["exp"]*0.1,gud[cGUData[id]["id"]]["loot"]["exp"]*0.1))
 addXP(expr)
 local coinsLoot = gud[cGUData[id]["id"]]["loot"]["coins"]
 local giveCoins = coinsLoot+math.ceil(coinsLoot*math.random(-(50+1.1^math.min(cGUData[id]["lvl"],35)),(50+1.1^math.min(cGUData[id]["lvl"],35)))/100)
 addCoins(giveCoins)
 itemLoot = {}
  if gud[cGUData[id]["id"]]["loot"]["drop"] then
   for f = 1, #gud[cGUData[id]["id"]]["loot"]["drop"] do
   itemLoot[#itemLoot+1] = gud[cGUData[id]["id"]]["loot"]["drop"][f]
   end
  end
  for f = 1, #t_loot[gud[cGUData[id]["id"]]["loot"]["items"]] do
  itemLoot[#itemLoot+1] = t_loot[gud[cGUData[id]["id"]]["loot"]["items"]][f]
  end
 itemLoot = getRandSeq(itemLoot)
 local nitemloop = 1
 if gud[cGUData[id]["id"]]["tcdrop"] then nitemloop = gud[cGUData[id]["id"]]["tcdrop"] end
  for l = 1, nitemloop do
   for f = 1, #itemLoot do
    if itemLoot[f][1] ~= nil and math.random(1,10^5) <= itemLoot[f][2]*10^3 then
    if math.random(1,100) >= 25 then itemLoot[f][1] = createNewItem(itemLoot[f][1]) end
 ...
 if gud[cGUData[id]["id"]]["daft_klz"] then dAfterkill(gud[cGUData[id]["id"]]["daft_klz"],cGUData[id]["x"]) end
 if gud[cGUData[id]["id"]]["nres"] == true then gud[cGUData[id]["id"]]["nres"] = false end
 end
 if damage > 0 then 
  if chchance == 1 then
  inderttunitinfo(id,"Урон "..math.ceil(damage)) 
  elseif chchance == 2 then
  inderttunitinfo(id,"Критический урон "..math.ceil(damage))
  end
 end
...
local atck, dmgRedu = math.random(cGUData[fromID]["ptk"][1]*10,cGUData[fromID]["ptk"][2]*10)/10, cGUData[1]["pdef"]/(cGUData[1]["pdef"]+cGUData[fromID]["lvl"]*30)
 if tipedm == "m" then
 atck = math.random(cGUData[fromID]["mtk"][1]*10,cGUData[fromID]["mtk"][2]*10)/10
 dmgRedu = cGUData[1]["mdef"]/(cGUData[1]["mdef"]+cGUData[fromID]["lvl"]*30)
 end
...
if cTarget == 0 then cTarget = fromID end 
 ...
 console.debug(unicode.sub(gud[cGUData[fromID]["id"]]["name"],1,25),"нанес",tostring(damage):sub(1,5).." ед. урона ("..tipedm..")")
 else
...
local function enemySkill(enemy,sl,lvl)
 if cGUData[enemy]["living"] and getDistanceToId(1,enemy) <= 60 and cGUData[enemy]["attPlayer"] == true and cGUData[enemy]["ctck"] then
  local dist = gud[cGUData[enemy]["id"]]["atds"]+eusd[sl]["distance"]
  if getDistanceToId(1,enemy) > dist then
   if cGUData[enemy]["x"] > cGUData[1]["x"] then
   cGUData[enemy]["spos"] = "l"
   cGUData[enemy]["mx"] = cGUData[1]["x"]+cGUData[1]["width"]+dist
   else
   cGUData[enemy]["spos"] = "r"
   cGUData[enemy]["mx"] = cGUData[1]["x"]-dist
   end
  else
  cGUData[enemy]["mx"] = cGUData[enemy]["x"]
  playerGetDamage(enemy,eusd[sl]["typedm"],math.random(eusd[sl]["mindamage"][lvl]*10,eusd[sl]["maxdamage"][lvl]*10)/10)
   if eusd[sl]["eff"] then
...
local damage = 0
 if gsd[cskill]["type"] == "attack" and cGUData[cTarget]["rtype"] ~= "p" and cGUData[cTarget]["rtype"] ~= "f" and cGUData[cTarget]["rtype"] ~= "r" and cGUData[cTarget]["rtype"] ~= "c" then
 ...
 local weaponDmg
   ...
   damage = damage + math.random(cGUData[1]["ptk"][1]*10,cGUData[1]["ptk"][2]*10)/10
   weaponDmg = math.random(vaddsPnts.vPdm1,vaddsPnts.vPdm2)
   elseif gsd[cskill]["typedm"] == "m" then
   damage = damage + math.random(cGUData[1]["mtk"][1]*10,cGUData[1]["mtk"][2]*10)/10
   weaponDmg = math.random(vaddsPnts.vMdm1,vaddsPnts.vMdm2)
   end
   if gsd[cskill]["basedmgmlt"] then damage = damage + damage*gsd[cskill]["basedmgmlt"][lvl]*0.01 end
  ...
  if gsd[cskill]["typedm"] == "p" then
  damage = math.max(damage*(1-cGUData[cTarget]["pdef"]/(cGUData[cTarget]["pdef"]+cGUData[1]["lvl"]*30)),0.1)
  elseif gsd[cskill]["typedm"] == "m" then
  damage = math.max(damage*(1-cGUData[cTarget]["mdef"]/(cGUData[cTarget]["mdef"]+cGUData[1]["lvl"]*30)),0.1)
  end
...
pckTarget = cTarget
pickingUp = true
mpcktime = math.random(gud[cGUData[cTarget]["id"]]["mnprs"]*10,gud[cGUData[cTarget]["id"]]["mxprs"]*10)
...
local function getRawCount(array)
local count = 0
...
local text = {
	...
	"#iconImageBuffer = "..getRawCount(iconImageBuffer),
	}
 for f = 1, #text do
...
local function dmain()
 if cWindowTrd ~= "inventory" and cWindowTrd ~= "tradeWindow" and cWindowTrd ~= "craftWindow" then
  ...
  if cGUData[1]["spos"] == "r" then buffer.image(pSprPicPos, 34, imageBuffer[cGUData[1]["image"]])
  else buffer.image(pSprPicPos, 34, image.flipHorizontal(image.duplicate(imageBuffer[cGUData[1]["image"]])))
  end
 drawCDataUnit()
...
elseif not cGUData[1]["living"] then
gfunc.youDEAD()
...
iconImageBuffer[0]={}
 for il = 1, #tblgbldblk do
  ...
  iconImageBuffer[0][tblgbldblk[il][1]] = image.load(cpath..tblgbldblk[il][2])
  end
 end
 for f = 1, #inventory["bag"] do
 ...
 for f = 1, #wItemTypes do
  ...
  iconImageBuffer[wItemTypes[f]] = image.load(cpath.."itempic/"..aItemIconsSpr[gid[inventory["weared"][wItemTypes[f]]]["icon"]]..".pic")
  end
 end
end
...
[6]=function()
saveGame("/games/testgame/saves","save")
end,
[7]=function()
loadGame("/games/testgame/saves","save")
end,
[8]=function()
ingame = false
end,
...
local qwert
 ...
 gamefps = 0
  ...
  manaReg = math.min(0.26+(cGUData[1]["lvl"]-1)*0.015,2) 
  healthReg = math.min(0.08+(cGUData[1]["lvl"]-1)*0.008,1) 
   ...
   for f = 2, #cGUData do
	...
	if not cGUData[f]["attPlayer"] and cGUData[f]["living"] then
	 if cGUData[f]["chp"]+math.ceil(cGUData[f]["mhp"]*0.05)<cGUData[f]["mhp"] then 
	 cGUData[f]["chp"]=cGUData[f]["chp"]+math.ceil(cGUData[f]["mhp"]*0.05)
	 else
	...
	if getDistanceToId(1,f) <= 384 and cGUData[f]["rtype"] == "e" and cGUData[f]["living"] and math.random(1,3) == 3 and uMoveRef == 0 then
	cGUData[f]["mx"] = cGUData[f]["sx"] + math.random(-16, 16)
	end  
    --
	 if cGUData[f]["rtype"] == "e" then
	  qwert = {gud[cGUData[f]["id"]]["skill"][#gud[cGUData[f]["id"]]["skill"]][1],gud[cGUData[f]["id"]]["skill"][#gud[cGUData[f]["id"]]["skill"]][2]}
	  for o = 1, #gud[cGUData[f]["id"]]["skill"] do
	   if math.random(1,100) <= gud[cGUData[f]["id"]]["skill"][o][3] then
	   qwert = {gud[cGUData[f]["id"]]["skill"][o][1],gud[cGUData[f]["id"]]["skill"][o][2]}
	   break
	   end
	  end
    ...
    -- агр мобов
	if cGUData[f]["living"] and gud[cGUData[f]["id"]]["agr"] == true and getDistanceToId(1,f) <= gud[cGUData[f]["id"]]["atds"]*2 then
    cGUData[f]["attPlayer"] = true
    end 
	-- самотаргет
	if cTarget == 0 and cGUData[f]["attPlayer"] == true then cTarget = f end	
    
    for m = 1, #cGUData[f]["tlinfo"] do
     if cGUData[f]["tlinfo"][1] then
	 table.remove(cGUData[f]["tlinfo"],1)
	 end
    end
   end
   -- обслуживание всех эффектов на всех объектах
   for f = 1, #cGUData do
    cGUData[f]["cmove"] = true
	cGUData[f]["ctck"] = true
	if f ~= 1 then
	 if not gud[cGUData[f]["id"]]["pdef"] then cGUData[f]["pdef"] = math.ceil(gud[cGUData[f]["id"]]["lvl"]*19.84+(gud[cGUData[f]["id"]]["lvl"]^2/1.5)) else cGUData[f]["pdef"] = gud[cGUData[f]["id"]]["pdef"] end
     if not gud[cGUData[f]["id"]]["mdef"] then cGUData[f]["mdef"] = math.ceil(gud[cGUData[f]["id"]]["lvl"]*18.31+(gud[cGUData[f]["id"]]["lvl"]^2/1.5)) else cGUData[f]["mdef"] = gud[cGUData[f]["id"]]["mdef"] end	
    end
	for eff = 1, #cGUData[f]["effects"] do
	 qwert = cGUData[f]["effects"][#cGUData[f]["effects"]-eff+1]
	 if cGUData[f]["living"] and qwert ~= nil then
	 ...
	 efftype = ged[qwert[1]]["type"]
	  ...
	  cGUData[f]["chp"] = math.min(cGUData[f]["chp"] + cGUData[f]["mhp"]*value*0.01,cGUData[f]["mhp"])
	  elseif efftype == "hpd" then
      makeDamage(f,value/duration)
	  elseif efftype == "pdfi%" then
	  cGUData[f]["pdef"] = cGUData[f]["pdef"]+math.ceil(value/100*cGUData[f]["pdef"])
	  elseif efftype == "mdfi%" then
	  cGUData[f]["mdef"] = cGUData[f]["mdef"]+math.ceil(value/100*cGUData[f]["mdef"])
	  elseif efftype == "stn" then
	  cGUData[f]["cmove"] = false
	  cGUData[f]["ctck"] = false
  ...
  if sScreenTimer1 > 0 then sScreenTimer1 = sScreenTimer1 - 1 end
   ...
   for f = 1, #inventory["bag"] do
    if inventory["bag"][f][1] > 0 and gid[inventory["bag"][f][1]] and inventory["bag"][f][2] > 0 and cGUData[1]["living"] and gid[inventory["bag"][f][1]]["type"] == "elementmul" then
     if gid[inventory["bag"][f][1]]["subtype"] == "hp" and cGUData[1]["chp"] <= cGUData[1]["mhp"]*(gid[inventory["bag"][f][1]]["props"]["r"]*0.01) then
	 cGUData[1]["chp"] = math.min(cGUData[1]["chp"]+cGUData[1]["mhp"]*0.01*gid[inventory["bag"][f][1]]["props"]["ics"],cGUData[1]["mhp"])
...
local function funcPrQfsec()
 while ingame do
  if not paused then
   ...
   for f = 2, #cGUData do
    if getDistanceToId(1,f) <= 140 and cGUData[f]["x"] ~= cGUData[f]["mx"] and not gud[cGUData[f]["id"]]["cmve"] and cGUData[f]["cmove"] then
	tblpbl = 0.25
	if cGUData[f]["attPlayer"] then 
	tblpbl = 0.5 
	if getDistanceToId(1,f) >= gud[cGUData[f]["id"]]["atds"]*2 then tblpbl = 1 end
	end	
	movetoward(f, cGUData[f]["mx"], 100, tblpbl)
	end 
   end
  end
 os.sleep(0.25)
...
local function funcP10()
 ...
 if not paused then
  if pickingUp then
   ...
   cGUData[1]["image"] = 0
   pickingUp = false
   itemLootarray = getRandSeq(gud[cGUData[pckTarget]["id"]]["items"])
   ...
   addXP(gud[cGUData[pckTarget]["id"]]["exp"])
   addCoins(gud[cGUData[pckTarget]["id"]]["coins"])
   playerCanMove = true
   cGUData[pckTarget]["living"] = false
   cGUData[pckTarget]["resptime"] = gud[cGUData[pckTarget]["id"]]["vresp"]
...
local ev, p2, p3, p4, p5 = event.pull()
 if ev == "key_down" then
  ...
  if (p4 == 205 or p4 == 32) and not paused and cGUData[1]["x"] <= world[world.current].limitR and playerCanMove and cGUData[1]["cmove"] then -- right
  ...
  elseif (p4 == 203 or p4 == 30) and not paused and cGUData[1]["x"] >= world[world.current].limitL and playerCanMove and cGUData[1]["cmove"] then -- left
   if keyboard.isAltDown() then
  ...
  if not paused then
   for f = 1, 6 do
    if cTarget ~= 0 and cUskills[f] ~= 0 and p4 == 1+f and cPlayerSkills[cUskills[f]][1] ~= 0 and gsd[cPlayerSkills[cUskills[f]][1]]["type"] ~= "buff" then
	 ...
	 plcmx = cGUData[cTarget]["mx"] - (vAttackDistance+gsd[cPlayerSkills[cUskills[f]][1]]["distance"]) - cGUData[1]["width"]
	 else
	 plcmx = cGUData[cTarget]["mx"] + cGUData[cTarget]["width"] + (vAttackDistance+gsd[cPlayerSkills[cUskills[f]][1]]["distance"])
	 end	 
  ...
  if not pickingUp and not paused and cTarget ~= 0 and cGUData[cTarget]["rtype"] == "r" and p4 == 18 and getDistanceToId(1,cTarget) <= 11 then
   if gud[cGUData[cTarget]["id"]]["reqquest"] then
    for m = 1, #cUquests do
	 if cUquests[m][1] == gud[cGUData[cTarget]["id"]]["reqquest"] and cUquests[m][3] ~= true then
  ...
  if not paused and not pickingUp and cTarget ~= 0 and cGUData[cTarget]["rtype"] == "c" and p4 == 18 and getDistanceToId(1,cTarget) <= 10 then
   if gud[cGUData[cTarget]["id"]]["tlp"] == "r" then
   loadWorld(world[world.current].drespawn)
   elseif type(gud[cGUData[cTarget]["id"]]["tlp"]) == "table" then
   teleport(gud[cGUData[cTarget]["id"]]["tlp"][2],gud[cGUData[cTarget]["id"]]["tlp"][1])
   end
  end
  ...
  if not paused and cWindowTrd == nil then   
   for f = 1, #inventory["bag"] do
	if inventory["bag"][f][1] > 0 and inventory["bag"][f][2] > 0 and gid[inventory["bag"][f][1]]["type"] == "potion" and cGUData[1]["lvl"] >= gid[inventory["bag"][f][1]]["reqlvl"] then
 ...
 if cWindowTrd == nil and cTarget ~= 0 and p5 == 0 and gud[cGUData[cTarget]["id"]]["rtype"] ~= "r" and clicked(p3,p4,60,5,71,5) then showTargetInfo = true 
	 ...
	 if inventory["bag"][formula][1] ~= 0 and inventory["bag"][formula][2] ~= 0 then
	  ...
	  pItem = gid[inventory["bag"][formula][1]]
	   ...
	   elseif p5 == 1 and gid[inventory["bag"][formula][1]] then
	    -- armor
		if pItem["type"] == "armor" and cGUData[1]["lvl"] >= pItem["reqlvl"] then
		 if inventory["weared"][pItem["subtype"]] == 0 then
	     inventory["weared"][pItem["subtype"]] = inventory["bag"][formula][1]
		 iconImageBuffer[pItem["subtype"]] = image.load(cpath.."itempic/"..aItemIconsSpr[gid[inventory["bag"][formula][1]]["icon"]]..".pic")
		 ...
		 inventory["weared"][pItem["subtype"]] = inventory["bag"][formula][1]
		 iconImageBuffer[gid[nwitemuwr]["subtype"]] = image.load(cpath.."itempic/"..aItemIconsSpr[gid[inventory["bag"][formula][1]]["icon"]]..".pic")
		 inventory["bag"][formula][1] = nwitemuwr
		 inventory["bag"][formula][2] = 1
		 iconImageBuffer[formula] = image.load(cpath.."itempic/"..aItemIconsSpr[gid[nwitemuwr]["icon"]]..".pic")
		 end
		-- weapon
		elseif pItem["type"] == "weapon" and cGUData[1]["lvl"] >= pItem["reqlvl"] then
		 if inventory["weared"]["weapon"] == 0 then
	     inventory["weared"]["weapon"] = inventory["bag"][formula][1]
		 iconImageBuffer["weapon"] = image.load(cpath.."itempic/"..aItemIconsSpr[gid[inventory["bag"][formula][1]]["icon"]]..".pic")
		 inventory["bag"][formula][1] = 0
		 inventory["bag"][formula][2] = 0
		  if iconImageBuffer[formula] ~= nil then
		  iconImageBuffer[formula] = nil
		...
		addsmsg3(unicode.sub(os.date(), #os.date()-7, #os.date()).." Использован предмет "..pItem["name"])
		inventory["bag"][formula][2] = inventory["bag"][formula][2]	- 1	
		elseif pItem["type"] == "potion" and cGUData[1]["lvl"] >= pItem["reqlvl"] then
    ...
    for i = 1, 2 do
     ...
     if inventory["weared"][wItemTypes[formula]] ~= 0 then
      if clicked(p3,p4,xps,yps,xps+19,yps+9) then
	   ...
	   iconImageBuffer[nwitemuwr] = image.load(cpath.."itempic/"..aItemIconsSpr[gid[inventory["weared"][wItemTypes[formula]]]["icon"]]..".pic")
 ...
 elseif cWindowTrd == "dialog" then
   ...
   for f = 1, #cDialog do
    if p5 == 0 and clicked(p3,p4,14,25+f,58,25+f) then
	 ...
	 craftw.twindow = cDialog[f]["do"]
	 craftw.sect = 1
	 cWindowTrd = "craftWindow"
	 elseif cDialog[f]["action"] == "dialog" then
	 cDialog = cDialog[f]["do"]
	 elseif cDialog[f]["action"] == "qdialog" and cGUData[1]["lvl"] >= gqd[cDialog[f]["q"]]["minlvl"] then
	 cDialog = cDialog[f]["do"]
	 elseif cDialog[f]["action"] == "getquest" and gqd[cDialog[f]["do"]]["comp"] == 0 and cGUData[1]["lvl"] >= gqd[cDialog[f]["do"]]["minlvl"] then
	 getQuest(cDialog[f]["do"])
	 gqd[cDialog[f]["do"]]["qstgve"] = cGUData[cTarget]["id"]
	   ...
	   -- *награда за задание*
	    ...
	    elseif tenb and gqd[cDialog[f]["do"]]["fct"] then
		 if gqd[cDialog[f]["do"]]["fct"] == "setquest" then
		  ...
		  gqd[gqd[cDialog[f]["do"]]["value"]]["qstgve"] = cGUData[cTarget]["id"]
	 ...
	 elseif cDialog[f]["action"] == "setWorld" and cGUData[1]["lvl"] >= cDialog[f]["reqlvl"] then
  ...
  elseif cWindowTrd == "tradeWindow" then
   ...
   if tradew.torg == 2 then
    for f = 1, #tradew.asmt do
	 ...
	 iconImageBuffer[1] = image.load(cpath.."itempic/"..aItemIconsSpr[gid[tradew.asmt[f][1]]["icon"]]..".pic")
	 tradew.titem = f
	 tradew.titemcount = 1
	 end
	end
   ...
   elseif tradew.torg == 1 and tradew.titem == 0 then
    for c = 1, #gameTradew[tradew.twindow] do
	 if p5 == 0 and clicked(p3,p4,2+c*26-26, 2, 2+c*25, 2) then
	 tradew.sect = c
	 break
	 end
	end
	for c = 1, math.min(#gameTradew[tradew.twindow][tradew.sect], 24) do
     if clicked(p3,p4,2,5+c*2-2,160,5+c*2) then
	 tradew.titem = c+4*tradew.tScrl-4
	 iconImageBuffer = {[1]=image.load(cpath.."itempic/"..aItemIconsSpr[gid[gameTradew[tradew.twindow][tradew.sect][tradew.titem]["item"]]["icon"]]..".pic")}
	 break
	 end
    end
   elseif tradew.torg == 1 and tradew.titem > 0 then
    if p5 == 0 and gid[gameTradew[tradew.twindow][tradew.sect][tradew.titem]["item"]]["stackable"] and tradew.titemcount < 100 and clicked(p3,p4,math.floor(80-smw/2)+13, math.floor(25-smh/2)+3,math.floor(80-smw/2)+13, math.floor(25-smh/2)+3) then -- +
    tradew.titemcount = tradew.titemcount + 1
  ...
  elseif cWindowTrd == "craftWindow" then
   ...
   if craftw.titem == 0 then
    for c = 1, #gameCraftw[craftw.twindow] do
	 if p5 == 0 and clicked(p3,p4,2+c*26-26, 2, 2+c*25, 2) then
	 craftw.sect = c
	 break
	 end
	end
	for c = 1, math.min(#gameCraftw[craftw.twindow][craftw.sect], 24) do
     if clicked(p3,p4,2,5+c*2-2,160,5+c*2) then
	 craftw.titem = c+4*tradew.tScrl-4
	 iconImageBuffer[1] = image.load(cpath.."itempic/"..aItemIconsSpr[gid[gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["item"]]["icon"]]..".pic")
	 break
	 end
    end
   else
    if p5 == 0 and gid[gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["item"]]["stackable"] and craftw.titemcount < 100 and clicked(p3,p4,math.floor(80-bmw/2)+13, math.floor(25-bmh/2)+3,math.floor(80-bmw/2)+13, math.floor(25-bmh/2)+3) then
    ...
    if clicked(p3,p4,math.floor(80-bmw/2),math.floor(25-bmh/2)+bmh,math.floor(80-bmw/2)+bmw,math.floor(25-bmh/2)+bmh+3) and cCoins >= craftw.titemcount*gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["cost"] then
	 -- нажатие на кнопку 'создать предмет'
	 checkVar1 = true
	 for i = 1, #gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["recipe"] do
	  if checkItemInBag(gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["recipe"][i][1]) < gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["recipe"][i][2]*craftw.titemcount then
	  checkVar1 = false
	  end
	 end
	if gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["cost"] > cCoins then checkVar1 = false end
	 if checkVar1 then
	  for d = 1, #gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["recipe"] do
	   for i = 1, #inventory["bag"] do
	    if inventory["bag"][i][1] == gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["recipe"][d][1] then
	    inventory["bag"][i][2] = inventory["bag"][i][2] - gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["recipe"][d][2]*craftw.titemcount
	 ...
	 for d = 1, craftw.titemcount do
	  Citem = gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["item"]
	  cCoins = cCoins - gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["cost"]
       if Citem ~= nil and 10^10-gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["chance"]*10^10 <= math.random(1,10^10) then
       if 10^10-(gameCraftw[craftw.twindow][craftw.sect][craftw.titem]["achance"] or 0)*10^10 <= math.random(1,10^10) then Citem = createNewItem(Citem) end
       addItem(Citem,1)
	   end
	  Citem = nil
	  end
  ...
  if clicked(p3,p4,skillstr.x+112,skillstr.y,skillstr.x+119,skillstr.y) then cWindowTrd = "pause" end
   ...
   if skillstr.targ > 0 then
    ...
    local blbl, checkv1, checkv2 = gsd[cPlayerSkills[skillstr.targ][1]], true, {}
	 if blbl["reqlvl"] then
	  if blbl["reqlvl"][cPlayerSkills[skillstr.targ][3]+1] > cGUData[1]["lvl"] then 
	  checkv1 = false 
	  end	 
	 end
	 if blbl["reqcn"] then
